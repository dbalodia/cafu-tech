...
// import { basePathForTemplates, dataAccessLevel as dataAccessLevels } from '../vars/appSettings';
...
//         },
//         companyId: safeObjectId(_get(tokenPayload, 'userCompanyId')),
//         regionId: convertIdsToObjectId(_get(tokenPayload, 'userRegionId')),
//         createdOn: new Date(),
//         modifiedOn: new Date(),
//     });
